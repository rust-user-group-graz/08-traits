...
In particular, the following command was used for HTML generation: `pandoc -t revealjs -s -o rustgraz_talk_08.html rustgraz_talk_08.md --self-contained --standalone -V theme=white -V revealjs-url=https://revealjs.com`
